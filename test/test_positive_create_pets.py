...
# тесты создание питомцев с позитивным сценарием
@log_api
@pytest.mark.api
@pytest.mark.event
def test_add_pets_with_valid_data(get_key,name='Kote', animal_type='cat', age='3', pet_photo='images/Kote.jpg'):
...
@pytest.mark.api
@pytest.mark.event
def test_add_pets_with_valid_data_without_photo(get_key, name='CоняБезФото', animal_type='кот', age='3'):
